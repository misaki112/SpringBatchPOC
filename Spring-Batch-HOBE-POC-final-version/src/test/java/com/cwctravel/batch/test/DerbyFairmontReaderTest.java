...
/**
 * This class tests the reader reading from Fairmont web service response.
 * <p>
...
public class DerbyFairmontReaderTest extends TestCase {
	@Autowired
	private ItemReader<HotelDescriptiveContent> restHotelReaderFairmontOne;
	...
	public void setUp() {
		...
		this.mockServer.expect(requestTo(fairmontOneURL))//
	...
	public void hyattReaderTest() throws Exception {
		...
		HotelDescriptiveContent hotel = this.restHotelReaderFairmontOne.read();
