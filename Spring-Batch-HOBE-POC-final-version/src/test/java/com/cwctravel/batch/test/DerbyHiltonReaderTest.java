...
/**
 * This class tests the reader reading from Hilton web service response.
 * <p>
...
public class DerbyHiltonReaderTest extends TestCase {
	@Autowired
	private ItemReader<HotelDescriptiveContent> restHotelReaderHilton;
	...
	public void setUp() {
		...
		this.mockServer.expect(requestTo(hiltonURL))//
	...
	public void hyattReaderTest() throws Exception {
		...
		HotelDescriptiveContent hotel = this.restHotelReaderHilton.read();
